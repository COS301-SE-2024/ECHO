...
export class MoodService {
  ...
  private _backgroundMoodClasses = {
      Anger:       'dark:bg-anger-background transition-colors duration-mood ease-in-out',
      Admiration:  'dark:bg-admiration-background transition-colors duration-mood ease-in-out',
      Fear:        'dark:bg-fear-background transition-colors duration-mood ease-in-out',
      Joy:         'dark:bg-joy-background transition-colors duration-mood ease-in-out',
      Neutral:     'dark:bg-default-background transition-colors duration-mood ease-in-out',
      Amusement:   'dark:bg-amusement-background transition-colors duration-mood ease-in-out',
      Annoyance:   'dark:bg-annoyance-background transition-colors duration-mood ease-in-out',
      Approval:    'dark:bg-approval-background transition-colors duration-mood ease-in-out',
      Caring:      'dark:bg-caring-background transition-colors duration-mood ease-in-out',
      Confusion:   'dark:bg-confusion-background transition-colors duration-mood ease-in-out',
      Curiosity:   'dark:bg-curiosity-background transition-colors duration-mood ease-in-out',
      Desire:      'dark:bg-desire-background transition-colors duration-mood ease-in-out',
      Disappointment: 'dark:bg-disappointment-background transition-colors duration-mood ease-in-out',
      Disapproval: 'dark:bg-disapproval-background transition-colors duration-mood ease-in-out',
      Disgust:     'dark:bg-disgust-background transition-colors duration-mood ease-in-out',
      Embarrassment: 'dark:bg-embarrassment-background transition-colors duration-mood ease-in-out',
      Excitement:  'dark:bg-excitement-background transition-colors duration-mood ease-in-out',
      Gratitude:   'dark:bg-gratitude-background transition-colors duration-mood ease-in-out',
      Grief:       'dark:bg-grief-background transition-colors duration-mood ease-in-out',
      Love:        'dark:bg-love-background transition-colors duration-mood ease-in-out',
      Nervousness: 'dark:bg-nervousness-background transition-colors duration-mood ease-in-out',
      Optimism:    'dark:bg-optimism-background transition-colors duration-mood ease-in-out',
      Pride:       'dark:bg-pride-background transition-colors duration-mood ease-in-out',
      Realisation: 'dark:bg-realisation-background transition-colors duration-mood ease-in-out',
      Relief:      'dark:bg-relief-background transition-colors duration-mood ease-in-out',
      Remorse:     'dark:bg-remorse-background transition-colors duration-mood ease-in-out',
      Sadness:     'dark:bg-sadness-background transition-colors duration-mood ease-in-out',
      Surprise:    'dark:bg-surprise-background transition-colors duration-mood ease-in-out',
  };
  constructor() {
    this.initMood();
  }
