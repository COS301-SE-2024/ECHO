...
5. **Recommendation Generation:** The function combines the clustering, sentiment, and genre data to generate a list of recommended songs. It prioritises songs that share similar emotional tones and genres with the input song. 
